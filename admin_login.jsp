...
<p align=right ><font color=blue> <li><a href="Logout.action" target="_blank">LogOut</a></li></font></p> 
</head>
...
<td>	
	...
	<td>	
	<a href="add_modify.jsp?id=<%=qs.getId()%>"><%=qs.getId()%></a>
		</td>
		<td>
	<%=qs.getQue()%>
		</td>
	...
	<br>
	<a href="add_modify.jsp?diff=1"><input type=button value=Add name=add ></a> 
...
<td>	
	...
	<a href="add_modify.jsp?diff=2"><input type=button value=Add name=add ></a> 
<input type=submit value=Delete name=delete><br><br>
</form> 
...
<td>	
	...
	<a href="add_modify.jsp?diff=3"><input type=button value=Add name=add ></a> 
<input type=submit value=Delete name=delete><br><br>
</form> 
